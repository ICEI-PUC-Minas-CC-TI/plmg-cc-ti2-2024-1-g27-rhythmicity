	...
	public void makeForm(int tipo, User user, int orderBy) {
		...
		for (User p : users) {
			...
			list += "\n<tr bgcolor=\"" + bgcolor + "\">\n" +
					...
					"\t<td align=\"center\" valign=\"middle\"><a href=\"/usuario/" + p.getID() + "\"><img src=\"/image/detail.svg\" width=\"20\" height=\"20\"/></a></td>\n" +
					"\t<td align=\"center\" valign=\"middle\"><a href=\"/usuario/update/" + p.getID() + "\"><img src=\"/image/update.svg\" width=\"20\" height=\"20\"/></a></td>\n" +
					"\t<td align=\"center\" valign=\"middle\"><a href=\"javascript:confirmarDeleteUser('" + p.getID() + "', '" + p.getNome() + "', '" + p.getEmail() + "');\"><img src=\"/image/delete.svg\" width=\"20\" height=\"20\"/></a></td>\n" +
					"</tr>\n";
		}
		list += "</table>";		
